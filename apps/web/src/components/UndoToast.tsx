...
/** Undo Toast popup used across all pages for actions that support undo. */
export function UndoToast({ message, onUndo, onExpire, duration = 5 }: UndoToastProps) {
  ...
  return (
    <div
      role="status"
      className="fixed bottom-6 right-6 z-[60] flex items-center gap-3 rounded-2xl border border-border bg-ink text-surface px-4 py-3 shadow-2xl animate-in slide-in-from-bottom-5 duration-200"
    >
